...
description: >
  ...
  doesn't match expectations, or you encounter any unexpected error. Follow a structured
  triage process to find and fix the root cause rather than guessing.
triggers:
  - "/debug"
  - "tests are failing"
  - "build is broken"
...
│   └── Run under load to increase collision probability
